...
def process_atoms(atoms):
    ...
    try:
        ...
        if not ltc_condition:
            ...
            return mat_id, info_dict | relax_dict | freqs_dict, {"fc2_set": fc2_set, "fc3_set": fc3_set}
        ...
        # continue
        return mat_id, info_dict | relax_dict, {"fc2_set": fc2_set, "fc3_set": fc3_set}
    ...
    return mat_id, info_dict | relax_dict | freqs_dict | kappa_dict, {"fc2_set": fc2_set, "fc3_set": fc3_set}
...
if __name__ == "__main__":
    ...
    with multiprocessing.Pool(processes=num_cores) as pool:
        results = list(pool.imap(process_atoms, atoms_list))

    print(results)
    kappa_results = {mat_id: result for mat_id, result, force in results}
    force_results = {mat_id: force for mat_id, result, force in results}
